    ...
    def get(self, request, **kwargs):
        ...
        for article in all_articles:
            article_data.append({
                ...
                'category': article.category.title,  # relation
...
class AllArticleAPIView(APIView):  # class base view
    ...
    def get(self, request, format=None):
        try:
            ...
            return Response({'status': 'Internal Server Error, Will Check it Later'},
...
class SearchArticleView(APIView):
    def get(self, request, format=None):
        try:
            ...
            articles = Article.objects.filter(Q(content__icontent=query))
            data = []
...
class DeleteArticleAPIView(APIView):
    def post(self, request, format=None):
        try:
            serializer = serializers.DeleteArticleCoverSerializer(data=request.data)
            if serializer.is_valid():
                article_id = serializer.data.get('article_id')
            else:
